...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.created_by'
        db.add_column('order_items', 'created_by',
                      self.gf('audit_log.models.fields.CreatingUserField')(related_name='created_orderitem_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrderItem.created_with_session_key'
        db.add_column('order_items', 'created_with_session_key',
                      self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'OrderItem.modified_by'
        db.add_column('order_items', 'modified_by',
                      self.gf('audit_log.models.fields.LastUserField')(related_name='modified_orderitem_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrderItem.modified_with_session_key'
        db.add_column('order_items', 'modified_with_session_key',
                      self.gf('audit_log.models.fields.LastSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'OrderItem.created'
        db.add_column('order_items', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.modified'
        db.add_column('order_items', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.created_by'
        db.add_column('deliveries', 'created_by',
                      self.gf('audit_log.models.fields.CreatingUserField')(related_name='created_orderdelivery_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrderDelivery.created_with_session_key'
        db.add_column('deliveries', 'created_with_session_key',
                      self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.modified_by'
        db.add_column('deliveries', 'modified_by',
                      self.gf('audit_log.models.fields.LastUserField')(related_name='modified_orderdelivery_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'OrderDelivery.modified_with_session_key'
        db.add_column('deliveries', 'modified_with_session_key',
                      self.gf('audit_log.models.fields.LastSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.created'
        db.add_column('deliveries', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.modified'
        db.add_column('deliveries', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.created_by'
        db.delete_column('order_items', 'created_by_id')

        # Deleting field 'OrderItem.created_with_session_key'
        db.delete_column('order_items', 'created_with_session_key')

        # Deleting field 'OrderItem.modified_by'
        db.delete_column('order_items', 'modified_by_id')

        # Deleting field 'OrderItem.modified_with_session_key'
        db.delete_column('order_items', 'modified_with_session_key')

        # Deleting field 'OrderItem.created'
        db.delete_column('order_items', 'created')

        # Deleting field 'OrderItem.modified'
        db.delete_column('order_items', 'modified')

        # Deleting field 'OrderDelivery.created_by'
        db.delete_column('deliveries', 'created_by_id')

        # Deleting field 'OrderDelivery.created_with_session_key'
        db.delete_column('deliveries', 'created_with_session_key')

        # Deleting field 'OrderDelivery.modified_by'
        db.delete_column('deliveries', 'modified_by_id')

        # Deleting field 'OrderDelivery.modified_with_session_key'
        db.delete_column('deliveries', 'modified_with_session_key')

        # Deleting field 'OrderDelivery.created'
        db.delete_column('deliveries', 'created')

        # Deleting field 'OrderDelivery.modified'
        db.delete_column('deliveries', 'modified')
