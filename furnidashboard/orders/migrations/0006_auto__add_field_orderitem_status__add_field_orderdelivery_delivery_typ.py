...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('order_items', 'status',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.delivery_type'
        db.add_column('deliveries', 'delivery_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('order_items', 'status')

        # Deleting field 'OrderDelivery.delivery_type'
        db.delete_column('deliveries', 'delivery_type')
