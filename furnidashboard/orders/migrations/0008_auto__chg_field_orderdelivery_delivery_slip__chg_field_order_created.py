...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderDelivery.delivery_slip'
        db.alter_column('deliveries', 'delivery_slip', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Order.created'
        db.alter_column('order_info', 'created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'OrderDelivery.delivery_slip'
        db.alter_column('deliveries', 'delivery_slip', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Changing field 'Order.created'
        db.alter_column('order_info', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
