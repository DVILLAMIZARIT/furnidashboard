...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderDelivery.pickup_from'
        db.alter_column('deliveries', 'pickup_from_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stores.Store'], null=True))
        # Adding field 'Order.order_date'
        db.add_column('order_info', 'order_date',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrderDelivery.pickup_from'
        db.alter_column('deliveries', 'pickup_from_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stores.Store']))
        # Deleting field 'Order.order_date'
        db.delete_column('order_info', 'order_date')
