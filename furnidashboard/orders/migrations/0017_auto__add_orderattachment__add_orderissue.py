...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('order_issues', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('audit_log.models.fields.CreatingUserField')(related_name='created_orderissue_set', to=orm['auth.User'])),
            ('created_with_session_key', self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True)),
            ('modified_by', self.gf('audit_log.models.fields.LastUserField')(related_name='modified_orderissue_set', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'orders', ['OrderIssue'])
