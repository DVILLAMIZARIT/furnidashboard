...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.created_by'
        db.add_column('order_info', 'created_by',
                      self.gf('audit_log.models.fields.CreatingUserField')(related_name='created_order_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Order.created_with_session_key'
        db.add_column('order_info', 'created_with_session_key',
                      self.gf('audit_log.models.fields.CreatingSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'Order.modified_by'
        db.add_column('order_info', 'modified_by',
                      self.gf('audit_log.models.fields.LastUserField')(related_name='modified_order_set', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Order.modified_with_session_key'
        db.add_column('order_info', 'modified_with_session_key',
                      self.gf('audit_log.models.fields.LastSessionKeyField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'Order.created'
        db.add_column('order_info', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Order.modified'
        db.add_column('order_info', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.created_by'
        db.delete_column('order_info', 'created_by_id')

        # Deleting field 'Order.created_with_session_key'
        db.delete_column('order_info', 'created_with_session_key')

        # Deleting field 'Order.modified_by'
        db.delete_column('order_info', 'modified_by_id')

        # Deleting field 'Order.modified_with_session_key'
        db.delete_column('order_info', 'modified_with_session_key')
