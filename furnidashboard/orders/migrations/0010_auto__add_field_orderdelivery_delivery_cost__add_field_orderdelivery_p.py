...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderDelivery.delivery_cost'
        db.add_column('deliveries', 'delivery_cost',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)

        # Adding field 'OrderDelivery.paid'
        db.add_column('deliveries', 'paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderDelivery.delivery_cost'
        db.delete_column('deliveries', 'delivery_cost')

        # Deleting field 'OrderDelivery.paid'
        db.delete_column('deliveries', 'paid')
