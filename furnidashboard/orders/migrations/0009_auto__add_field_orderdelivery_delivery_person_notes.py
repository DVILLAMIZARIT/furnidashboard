...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderDelivery.delivery_person_notes'
        db.add_column('deliveries', 'delivery_person_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderDelivery.delivery_person_notes'
        db.delete_column('deliveries', 'delivery_person_notes')
