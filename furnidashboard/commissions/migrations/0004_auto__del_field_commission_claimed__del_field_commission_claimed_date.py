...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Commission.claimed'
        db.delete_column('commissions', 'claimed')

        # Deleting field 'Commission.claimed_date'
        db.delete_column('commissions', 'claimed_date')


    def backwards(self, orm):
        # Adding field 'Commission.claimed'
        db.add_column('commissions', 'claimed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Commission.claimed_date'
        db.add_column('commissions', 'claimed_date',
