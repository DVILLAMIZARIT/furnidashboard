...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commission.claimed_date'
        db.alter_column('commissions', 'claimed_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Commission.paid_date'
        db.alter_column('commissions', 'paid_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Commission.claimed_date'
        db.alter_column('commissions', 'claimed_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Commission.paid_date'
        db.alter_column('commissions', 'paid_date', self.gf('django.db.models.fields.DateField')())
