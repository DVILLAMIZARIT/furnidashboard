...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('commissions', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('associate', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], null=True, blank=True)),
            ...
            ('claimed_date', self.gf('django.db.models.fields.DateField')(default='', blank=True)),
            ('paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('paid_date', self.gf('django.db.models.fields.DateField')(default='', blank=True)),
        ))
        db.send_create_signal(u'commissions', ['Commission'])


    def backwards(self, orm):
        # Deleting model 'Commission'
        db.delete_table('commissions')
    ...
    models = {
        ...
        u'commissions.commission': {
            ...
            'claimed_date': ('django.db.models.fields.DateField', [], {'default': "''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['orders.Order']"}),
            'paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'paid_date': ('django.db.models.fields.DateField', [], {'default': "''", 'blank': 'True'})
        },
