...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commission.order'
        db.alter_column('commissions', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.Order'], unique=True))
        # Adding unique constraint on 'Commission', fields ['order']
        db.create_unique('commissions', ['order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Commission', fields ['order']
        db.delete_unique('commissions', ['order_id'])


        # Changing field 'Commission.order'
        db.alter_column('commissions', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order']))
    ...
    models = {
        ...
        u'commissions.commission': {
            ...
            'associate': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'claimed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'claimed_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['orders.Order']", 'unique': 'True'}),
